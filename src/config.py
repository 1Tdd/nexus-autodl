# Config file - timing, mouse, vision
# Defaults work fine, don't touch unless you know what you're doing
...
class MatchingConfig:
    ...
    # Below this = fallback to ORB/AKAZE feature matching (slower but better for tricky buttons)
    ...
    #   "akaze"    - AKAZE features only (slowest, most reliable)
...
def load_config(path: str = "config.yaml") -> AppConfig:
    # Load config from YAML file with fallback handling
